...
Now, the core mechanism for system building has been laid out:
* Systems
* Stocks, flows, goals, events, feedback loops
* Relationships

Next, to make the app more useful there are a few more concepts:
* Processes
* Notes
* History
* Links
...
- Note: this needs to be refined because should flows trigger external sources? Perhaps...
